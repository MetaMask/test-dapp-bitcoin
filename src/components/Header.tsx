  ...
  return (
    ...
    >
      <div style={{ wordWrap: 'break-word' }}>
        ...
        >
          <option data-testid={dataTestIds.testPage.header.networks.mainnet} value="bitcoin:mainnet">
            Mainnet
          </option>
          <option data-testid={dataTestIds.testPage.header.networks.testnet} value="bitcoin:testnet">
            Testnet
          </option>
        </select>
      </div>
